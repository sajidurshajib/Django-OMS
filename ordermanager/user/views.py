...
from .serializers import RegisterSerializer, UserSerializer, UserUpdateSerializer, PasswordUpdateSerializer
...
@swagger_auto_schema(method='patch', tags=['auth'], operation_id='user_update', request_body=UserUpdateSerializer)
@api_view(['PATCH'])
@permission_classes([IsAuthenticated])
@authentication_classes([SessionAuthentication, JWTAuthentication])
...
@swagger_auto_schema(method='post', tags=['auth'], operation_id='user_password_update', request_body=PasswordUpdateSerializer)
@api_view(['POST'])
@permission_classes([IsAuthenticated])
@authentication_classes([SessionAuthentication, JWTAuthentication])
